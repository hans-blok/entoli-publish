---
type: essay
name: Eén as, één vraag — het ontvlechten van Source-regime, Synthesis-regime en Task Mode
version: 1.2.0
date: 2026-07-20
status: current
---
...
**Synthesis** is het proces waarbij een taalmodel Bronnen combineert, integreert of samenbrengt tot één samenhangende output, in tegenstelling tot het enkel opzoeken of overnemen van een Bron. De term wordt in het vakgebied losjes gebruikt — hij benoemt een *functie* die een model vervult, geen gestandaardiseerde API-parameter — maar komt terug in enkele gevestigde betekenissen:

- **Response synthesis** (retrieval-augmented generation): de pipelinestap waarin een of meer geraadpleegde Runtime-bronnen worden gecombineerd tot één antwoord. Frameworks die RAG-pipelines als discrete stappen blootleggen, benoemen deze stap doorgaans expliciet (bijvoorbeeld als een "response synthesizer"-component), gescheiden van retrieval en reranking.
...
# Eén as, één vraag — het ontvlechten van Source-regime, Synthesis-regime en Task Mode

Modelweergave: [Entoli view](https://hans-blok.github.io/entoli-publish/views/?view=id-1804920721c441e99fa0b0cee4c77f6a)
...
| Extracting | **Extracting** | ongewijzigd — isoleert uitsluitend wat al in de geraadpleegde Bron aanwezig is, ongeacht hoe breed het doorzochte domein is (Source-regime = Open kan dus samengaan met Task Mode = Extracting, bijvoorbeeld: vrij zoeken over het hele internet, maar niets toevoegen dat niet letterlijk gevonden is) |
